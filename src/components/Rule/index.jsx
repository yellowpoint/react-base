      ...
      >
        <div className={styles.ruleBox}>
          ...
          <div className={styles.ruleMain}>
            <h1>如何召唤丁丁12星座NFT</h1>
            <p>满足等级条件的相应会员</p>
            <p>可获取相关召唤丁丁12星座NFT数字藏品、红包款式1权益</p>

            <table>
              <thead>
                <tr>
                  <th>会员等级</th>
                  <th>免费召唤丁丁12星座NFT、红包款式 1</th>
                  <th>
                    积分召唤丁丁12星座NFT、红包款式 1<br />
            ...
            <p>丁丁龙年微信红包封面一共有2款</p>
            <p>款式一：</p>
            <p>满足等级条件的相应会员，点击立即召唤即有机会获得。</p>
            <p>款式二：</p>
            <p>
              集齐丁丁12星座NFT藏品，即可同步获得（限量100个），数量有限，领完即止。
            </p>
            <h1>关于结束藏品之旅</h1>
            <p>
              集齐丁丁12星座、丁丁龙年隐藏款，和龙年红包封面款式一，活动自动结束。
            </p>
